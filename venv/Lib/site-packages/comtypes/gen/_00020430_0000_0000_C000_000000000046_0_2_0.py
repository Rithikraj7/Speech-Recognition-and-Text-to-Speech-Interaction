...
__all__ = [
    'StdPicture', 'OLE_YSIZE_HIMETRIC', 'OLE_COLOR', 'FONTBOLD',
    'OLE_YSIZE_CONTAINER', 'Checked', 'OLE_ENABLEDEFAULTBOOL',
    'IFont', 'IFontDisp', 'OLE_YPOS_PIXELS', 'StdFont', 'Gray',
    'IPictureDisp', 'FONTSTRIKETHROUGH', 'LoadPictureConstants',
    'Font', 'OLE_HANDLE', 'FONTNAME', 'OLE_XPOS_PIXELS',
    'OLE_YPOS_CONTAINER', 'OLE_XPOS_CONTAINER', 'OLE_OPTEXCLUSIVE',
    'IPicture', 'OLE_XPOS_HIMETRIC', 'OLE_TRISTATE', 'OLE_CANCELBOOL',
    'FontEvents', 'Default', 'Color', 'VgaColor', 'FONTITALIC',
    'Monochrome', 'Picture', 'OLE_XSIZE_PIXELS', 'OLE_XSIZE_HIMETRIC',
    'OLE_YPOS_HIMETRIC', 'OLE_XSIZE_CONTAINER', 'FONTSIZE',
    'OLE_YSIZE_PIXELS', 'IFontEventsDisp', 'FONTUNDERSCORE',
    'Unchecked'
]

_check_version('1.2.0', 1651900787.524225)
