...
__all__ = [
    'SVP_15', 'SREPropertyNumChange', 'DISPID_SRCESoundEnd',
    'SPBINARYGRAMMAR', 'ISpeechPhraseProperties', 'DISPID_SOTSetId',
    'SPSHORTCUTTYPE', 'SpeechStreamFileMode',
    'DISPID_SPEAudioSizeBytes', 'SPGRAMMARSTATE', 'SPPHRASEELEMENT',
    'ISpeechRecoGrammar', 'SAFT8kHz16BitMono', 'SPGS_ENABLED',
    'SPCATEGORYTYPE', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SPRDisplayAttributes', 'DISPID_SOTsCount',
    'DISPID_SRCEPropertyStringChange', 'SDTDisplayText',
    'DISPID_SOTCSetId', 'SVP_10', 'SPPS_Noun',
    'DISPID_SRCRetainedAudio', 'SDKLDefaultLocation',
    'SSTTTextBuffer', 'DISPID_SLAddPronunciation', 'SPAUDIOSTATUS',
    'tagSPPROPERTYINFO', 'STCRemoteServer',
    'DISPID_SABIMinNotification', 'SpMemoryStream',
    'ISpeechPhraseInfo', 'SASRun', 'SpAudioFormat',
    'DISPID_SRGDictationSetState', 'DISPID_SRGRecoContext',
    'DISPID_SLWsItem', 'ISpeechAudio', 'SP_VISEME_20',
    'DISPID_SPCPhoneToId', 'SRSInactiveWithPurge', 'SpeechRunState',
    'DISPID_SpeechPhraseElement', 'ISpNotifySink',
    'SpeechEngineConfidence', 'SpeechFormatType', 'SVEViseme',
    'DISPID_SLWLangId', 'ISpeechPhraseRule', 'SPPS_Noncontent',
    'SAFT8kHz16BitStereo', 'DISPID_SRRRecoContext',
    'SpeechPropertyAdaptationOn', 'DISPID_SLWWord',
    'eWORDTYPE_DELETED', 'SPCT_SUB_COMMAND',
    'DISPID_SPEDisplayAttributes', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SOTCGetDataKey', 'SAFT11kHz16BitStereo',
    'DISPID_SVSInputWordPosition', 'SSFMOpenReadWrite',
    'DISPID_SOTGetStorageFileName', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPEI_SR_BOOKMARK', 'ISpRecoContext2', 'DISPID_SVEViseme',
    'SVSFParseMask', 'SREStreamEnd', 'ISpNotifyTranslator',
    'SDA_No_Trailing_Space', 'SPSHT_NotOverriden', 'SVP_18',
    'DISPID_SpeechObjectTokens', 'SPWORDPRONUNCIATION',
    'SpNotifyTranslator', 'DISPID_SREmulateRecognition',
    'ISpeechLexiconPronunciation', 'ISpeechRecognizerStatus',
    'eLEXTYPE_PRIVATE2', 'SVSFParseSapi',
    'DISPID_SPIRetainedSizeBytes', 'SPWT_DISPLAY',
    'ISpeechTextSelectionInformation', 'DISPID_SPPEngineConfidence',
    'SVSFPurgeBeforeSpeak', 'SGPronounciation', 'ISpeechLexicon',
    ...
    'SPEI_RESERVED5', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SPEs_NewEnum', 'SPGRAMMARWORDTYPE', 'SPSVerb',
    'SPRECOCONTEXTSTATUS', 'ISpeechGrammarRule', 'DISPID_SGRsDynamic',
    'SPPS_Unknown', 'DISPID_SRCCreateGrammar', 'SPSSuppressWord',
    'eLEXTYPE_PRIVATE13', 'DISPID_SRGDictationLoad', 'SLODynamic',
    ...
    'ISpObjectTokenCategory', 'DISPID_SRCEHypothesis', 'SP_VISEME_9',
    'DISPID_SVEAudioLevel', 'SPWORDTYPE', 'SAFTText',
    'SECFIgnoreKanaType', 'eLEXTYPE_VENDORLEXICON',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SRADefaultToActive',
    'DISPID_SVSInputWordLength', 'DISPID_SpeechGrammarRuleState',
    'SAFTADPCM_11kHzStereo', 'DISPID_SVSkip', 'SPWORDPRONOUNCEABLE',
    'SDA_Consume_Leading_Spaces', 'SAFT8kHz8BitStereo',
    'SpeechAudioProperties', 'DISPID_SGRSTType',
    'DISPID_SVEventInterests', 'DISPID_SOTRemoveStorageFileName',
    'SECNormalConfidence', 'DISPID_SGRsFindRule', 'SPXRO_SML',
    ...
    'SAFT16kHz16BitStereo', 'DISPID_SASetState', 'SVP_14',
    'DISPID_SVSRunningState', 'DISPID_SOTCId', 'DISPID_SRGId',
    'SRARoot', 'DISPID_SpeechGrammarRules',
    'DISPID_SVSInputSentenceLength', 'SpeechCategoryPhoneConverters',
    'SVPNormal', 'ISpeechAudioBufferInfo', 'SDTAudio',
    'SREAdaptation', 'SASClosed', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRSetPropertyString',
    'SDKLLocalMachine', 'SVP_8', 'DISPID_SASNonBlockingIO',
    'DISPID_SPISaveToMemory', 'DISPID_SAEventHandle',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpeechGrammarRuleState',
    'DISPID_SGRsCommitAndSave', 'DISPID_SGRSTText',
    'DISPID_SMSALineId', 'STSF_LocalAppData', 'DISPID_SRRPhraseInfo',
    'SVP_5', 'SPCS_ENABLED', 'SpeechTokenKeyUI', 'SPSERIALIZEDRESULT',
    'SVESentenceBoundary', 'DISPID_SOTId', 'DISPID_SVVolume',
    'SSFMCreate', 'eLEXTYPE_USER', 'SpeechBookmarkOptions',
    'SpeechGrammarRuleStateTransitionType', 'ISpeechObjectTokens',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SWFESamplesPerSec', 'DISPID_SVDisplayUI',
    'DISPID_SBSWrite', 'SPEI_SENTENCE_BOUNDARY', 'SPRS_INACTIVE',
    'DISPID_SPIEngineId', 'IInternetSecurityMgrSite', 'SP_VISEME_7',
    'SP_VISEME_21', 'DISPID_SPPParent', 'DISPID_SPARecoResult',
    'SVF_None', 'ISpDataKey', 'SREBookmark',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SVEEnginePrivate',
    'SVSFIsFilename', 'SPRS_ACTIVE', 'SpeechCategoryRecognizers',
    'SVF_Emphasis', 'SPFILEMODE', 'SVP_16',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SPPFirstElement',
    'SREAudioLevel', 'ISpLexicon', 'SWTDeleted',
    'SAFTGSM610_44kHzMono', 'DISPID_SVEStreamStart', 'DISPID_SBSRead',
    'Speech_StreamPos_RealTime', 'DISPID_SOTGetAttribute',
    'ISpeechAudioStatus', 'DISPID_SRDisplayUI', 'DISPID_SABufferInfo',
    'DISPID_SPEPronunciation', 'SPEI_SOUND_START', 'SPBO_AHEAD',
    'DISPID_SpeechCustomStream', 'SVEPrivate', 'SPPS_Function',
    'DISPID_SPIGetText', 'DISPID_SGRInitialState', 'SVP_17',
    'SVSFDefault', 'DISPID_SRSCurrentStreamPosition',
    'SGLexicalNoSpecialChars', 'SVP_6', 'SpeechGrammarState',
    'eLEXTYPE_PRIVATE16', 'SpInprocRecognizer', 'ISpRecognizer',
    'DISPID_SAStatus', 'DISPID_SRCEPropertyNumberChange',
    'SVF_Stressed', 'SVP_21', 'SGRSTTWord', 'DISPID_SPPsItem',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SGRName', 'DISPID_SLWsCount',
    'SPAS_RUN', 'SpeechAudioVolume', 'SPAUDIOBUFFERINFO',
    'DISPID_SpeechPhraseRules', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SPIStartTime', 'eLEXTYPE_PRIVATE9', 'SPVISEMES',
    'DISPID_SABIBufferSize', 'DISPID_SPIAudioSizeBytes',
    'SpeechAudioState', 'DISPID_SRRAudioFormat',
    'SAFT44kHz8BitStereo', 'SpeechRecoEvents', 'SGDSInactive',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRCreateRecoContext',
    'DISPID_SPPChildren', 'SPSMF_UPS', 'SpeechDataKeyLocation',
    'SpeechCategoryAudioOut', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SRGReset', 'SLTApp',
    'SFTInput', 'IEnumString', 'SPPS_SuppressWord',
    'DISPID_SVSLastResult', 'SpPhraseInfoBuilder', 'SITooLoud',
    'DISPID_SABufferNotifySize', 'ISpeechRecoResultTimes',
    'DISPID_SpeechFileStream', 'DISPID_SPPsCount',
    'SAFT16kHz8BitStereo', 'SAFTCCITT_ALaw_8kHzMono',
    'SPEI_REQUEST_UI', 'tagSTATSTG', 'ISpAudio',
    'DISPID_SPRuleParent', 'DISPID_SRGSetTextSelection',
    'DISPID_SRRecognizer', 'ISpPhrase', 'DISPID_SPPValue',
    'SPRST_NUM_STATES', 'DISPID_SWFEChannels', 'DISPID_SPPConfidence',
    'SpeechRuleState', 'DISPID_SVIsUISupported', 'SRAORetainAudio',
    'SRTSMLTimeout', 'SPFM_CREATE', 'eWORDTYPE_ADDED',
    'DISPID_SDKEnumValues', 'SITooFast', 'DISPID_SRCEBookmark',
    'DISPID_SpeechBaseStream', 'SpeechWordType', 'SVEWordBoundary',
    'SPRST_ACTIVE', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SVSpeak', 'SBOPause', 'SPEI_START_SR_STREAM',
    'SP_VISEME_8', 'SPSEMANTICERRORINFO', 'DISPID_SLPsItem',
    'DISPID_SPAsCount', 'DISPID_SpeechMMSysAudio',
    'SpeechLexiconType', 'DISPID_SPILanguageId',
    'DISPID_SVSyncronousSpeakTimeout', 'SGDSActiveWithAutoPause',
    'DISPID_SGRId', 'DISPID_SPAStartElementInResult',
    'DISPID_SOTCategory', 'SAFT22kHz8BitStereo', 'ISpeechRecoResult',
    'SPEI_ADAPTATION', 'SPLO_STATIC', 'SPEI_MIN_SR', 'SPWORD',
    'SREPhraseStart', 'SVP_2', 'DISPID_SFSClose',
    'DISPID_SCSBaseStream', 'SPINTERFERENCE_NOISE',
    'DISPID_SPERequiredConfidence', 'eLEXTYPE_APP',
    'Speech_StreamPos_Asap', 'SPWF_INPUT',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPAR_Unknown',
    'SPWT_PRONUNCIATION', 'SPPS_RESERVED3', 'SAFTADPCM_22kHzStereo',
    'ISpObjectToken', 'SpeechVoiceSpeakFlags', 'SAFT44kHz16BitMono',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SVP_4', 'SPEI_SR_PRIVATE',
    'SP_VISEME_15', 'DISPID_SOTCreateInstance', 'SPRULE',
    'SPDKL_CurrentConfig', 'DISPID_SpeechPhraseAlternates',
    'SpShortcut', 'DISPID_SPRText', 'SREStateChange',
    'DISPID_SpeechPhraseRule', 'SGRSTTRule', 'SECLowConfidence',
    'SpMMAudioEnum', 'eLEXTYPE_RESERVED6', 'SPPS_LMA',
    'SPEI_RECO_OTHER_CONTEXT', 'SPSInterjection',
    'SAFTADPCM_22kHzMono', 'DISPID_SVEStreamEnd', 'DISPIDSPRG',
    'SPINTERFERENCE', 'DISPID_SPRsItem', 'SPVPRI_OVER',
    'DISPID_SRCBookmark', 'DISPID_SPEAudioStreamOffset',
    'SpPhoneConverter', 'DISPID_SAFGetWaveFormatEx', 'SVP_9',
    'SVSFIsNotXML', 'SpeechGrammarTagDictation', 'SPAO_RETAIN_AUDIO',
    'SP_VISEME_6', 'DISPID_SRState', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SPRNumberOfElements', 'DISPID_SVGetProfiles',
    'SpeechVoiceCategoryTTSRate', 'SECFIgnoreWidth',
    'ISpeechMemoryStream', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRGIsPronounceable', 'SPEI_SOUND_END',
    'DISPID_SRCEInterference', 'SAFT24kHz8BitMono',
    'ISpeechBaseStream', 'DISPID_SPAsItem', 'SPGS_EXCLUSIVE',
    'SECFNoSpecialChars', 'SPRST_INACTIVE',
    'SpeechDictationTopicSpelling', 'DISPID_SRGCommit',
    'DISPID_SPRulesCount', 'SPAR_High', 'SPVPRI_NORMAL',
    'SPCS_DISABLED', 'SAFTGSM610_11kHzMono',
    'SWPKnownWordPronounceable', 'DISPID_SRProfile',
    'SPRST_INACTIVE_WITH_PURGE', 'SPEI_WORD_BOUNDARY',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SPPNumberOfElements', 'DISPID_SVVoice',
    'SSSPTRelativeToStart', 'SPRECOGNIZERSTATUS',
    'SpeechCategoryAudioIn', 'DISPID_SPRsCount',
    'ISpeechObjectTokenCategory', 'DISPID_SGRAttributes',
    'SPEI_PROPERTY_STRING_CHANGE', 'SASStop', 'DISPID_SOTDataKey',
    'SRTAutopause', 'SpeechAllElements', 'ISpeechPhraseProperty',
    'DISPID_SBSFormat', 'DISPID_SRGDictationUnload',
    'SpeechDisplayAttributes', 'SRSActive', 'WAVEFORMATEX',
    'DISPID_SRSClsidEngine', 'SpeechPropertyResourceUsage',
    'SRTEmulated', 'DISPID_SBSSeek', 'SpeechVisemeType',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SpeechCategoryVoices',
    'ISpGrammarBuilder', 'SPWORDLIST', 'SPVPRI_ALERT',
    'DISPID_SpeechVoiceStatus', 'SPFM_OPEN_READWRITE',
    'ISpObjectWithToken', 'ISpeechVoiceStatus',
    'DISPID_SGRSAddSpecialTransition', 'LONG_PTR',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SpeechPhraseProperty',
    'DISPID_SVESentenceBoundary', 'SITooSlow', 'SECFDefault',
    'SRCS_Disabled', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPWF_SRENGINE', 'DISPID_SVSLastBookmark', 'DISPID_SPRuleName',
    'DISPID_SRRSpeakAudio', 'DISPID_SAFType', 'SPRULESTATE',
    'SPEI_MIN_TTS', 'DISPID_SGRSTNextState',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SPCLangId',
    'SpeechUserTraining', 'SPEI_UNDEFINED', 'DISPID_SVWaitUntilDone',
    'DISPID_SRIsShared', 'DISPID_SAFGuid', 'DISPID_SpeechObjectToken',
    'DISPID_SPCIdToPhone', 'DISPID_SVStatus', 'DISPID_SGRs_NewEnum',
    'DISPID_SpeechVoice', 'DISPID_SVRate', 'SPSLMA',
    'SVEEndInputStream', 'ISpeechVoice', 'DISPID_SLWType',
    'SSTTDictation', 'SPEI_RESERVED2', 'SLTUser', 'SVPOver',
    'DISPID_SWFEFormatTag', 'SP_VISEME_16',
    'DISPID_SPRuleFirstElement', 'SRAImport', 'SP_VISEME_11',
    'SVSFVoiceMask', 'SPLEXICONTYPE', 'SPEI_SR_AUDIO_LEVEL',
    'ISpeechPhraseRules', 'SpCompressedLexicon', 'DISPID_SLPPhoneIds',
    'DISPID_SpeechPhraseElements', 'SAFT32kHz8BitStereo',
    'ISpeechXMLRecoResult', 'SpeechAudioFormatType', 'ISpVoice',
    'DISPIDSPTSI_ActiveOffset', 'SVP_11', 'SGRSTTTextBuffer',
    'DISPID_SLPType', 'SP_VISEME_19', 'SPBO_NONE',
    'SpeechRecoContextState', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRGState', 'DISPID_SpeechGrammarRule',
    'DISPID_SpeechObjectTokenCategory', 'SPEVENTSOURCEINFO',
    'SPEVENTENUM', 'SP_VISEME_5', 'DISPID_SABIEventBias',
    'SpeechPropertyResponseSpeed', 'DISPID_SPEEngineConfidence',
    'SAFT24kHz16BitStereo', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SpeechLexiconProns',
    'DISPID_SRCEAudioLevel', 'DISPID_SOTIsUISupported',
    'eLEXTYPE_PRIVATE1', 'SpeechEmulationCompareFlags',
    'SAFT11kHz16BitMono', 'eLEXTYPE_PRIVATE5', 'ISpRecoResult',
    'SRSActiveAlways', 'ISpEventSink', 'SPEVENT',
    'SpeechPartOfSpeech', 'SAFT22kHz16BitStereo', 'SGSDisabled',
    'ISpeechPhoneConverter', 'SpeechStreamSeekPositionType',
    'SRERecoOtherContext', 'SPVPRIORITY',
    'SpeechPropertyHighConfidenceThreshold',
    'SpeechPropertyComplexResponseSpeed', 'SPEI_RESERVED6',
    'DISPID_SpeechRecoContext', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPPId', 'SECHighConfidence', 'DISPID_SRCESoundStart',
    'SAFT32kHz16BitStereo', 'SVP_3', 'SRESoundStart', 'SPPHRASE',
    'ISpeechFileStream', 'DISPID_SVSLastStreamNumberQueued',
    'SPEI_PHRASE_START', 'DISPID_SPIAudioStreamPosition',
    '_ISpeechVoiceEvents', 'DISPID_SGRSTsCount', 'ISpRecognizer3',
    'DISPID_SRGCmdLoadFromObject', 'SpWaveFormatEx',
    'DISPID_SVSVisemeId', 'SRSEIsSpeaking', 'SAFTADPCM_8kHzMono',
    'SGSExclusive', 'SPSTREAMFORMATTYPE', 'DISPID_SGRSTWeight',
    'ISpSerializeState', 'SpeechVoicePriority', 'SPDATAKEYLOCATION',
    'SDKLCurrentUser', 'SPEI_VOICE_CHANGE', 'SPPS_RESERVED4',
    'ISpShortcut', 'SpeechTokenValueCLSID',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRGetFormat',
    'eLEXTYPE_USER_SHORTCUT', 'SFTSREngine', 'ISpXMLRecoResult',
    'DISPID_SRSNumberOfActiveRules', 'SAFTCCITT_uLaw_8kHzMono',
    'eLEXTYPE_PRIVATE12', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SAVolume',
    'DISPID_SRSSupportedLanguages', 'ISpeechRecoResult2',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPEsCount',
    'DISPID_SRCEEndStream', 'eLEXTYPE_PRIVATE19', 'SVP_19',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SVSPhonemeId',
    'SREInterference', 'DISPID_SPACommit', 'DISPID_SLPSymbolic',
    'SRCS_Enabled', 'SGLexical', 'SVSFNLPSpeakPunc',
    'DISPID_SLPs_NewEnum', 'STSF_AppData', 'SPEI_TTS_PRIVATE',
    'SPPHRASEREPLACEMENT', 'SPSUnknown',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SOTCDefault',
    ...
    'DISPID_SDKSetBinaryValue', 'DISPID_SRCPause', 'SPPHRASEPROPERTY',
    'SGRSTTDictation', 'ISpeechDataKey', 'SRESoundEnd',
    'DISPID_SGRSTPropertyName', 'SVEAudioLevel', 'SAFT16kHz8BitMono',
    'DISPID_SRAudioInput', 'SRAInterpreter', 'ISpeechAudioFormat',
    'DISPID_SDKOpenKey', 'SPSERIALIZEDPHRASE', 'SPPHRASERULE',
    ...
    'SPEI_RECOGNITION', 'SRAONone', 'DISPID_SAFSetWaveFormatEx',
    'SVSFNLPMask', 'SAFTCCITT_ALaw_44kHzMono',
    'SpObjectTokenCategory', 'SpMMAudioOut', 'SAFTADPCM_44kHzMono',
    'DISPID_SVAlertBoundary', 'DISPID_SLWPronunciations',
    'DISPID_SRCResume', 'SPSHORTCUTPAIR', 'SPCT_COMMAND', 'SINone',
    'SPEI_TTS_BOOKMARK', 'SPPS_Verb', 'SVSFParseAutodetect',
    'SGRSTTEpsilon', 'SPAUDIOSTATE', 'SAFT24kHz8BitStereo',
    'DISPID_SpeechPhoneConverter', 'SRERequestUI', 'DISPID_SRCState',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SDKLCurrentConfig',
    'SPAUDIOOPTIONS', 'SPDKL_CurrentUser', 'SpSharedRecognizer',
    'DISPID_SVGetAudioInputs', 'SREStreamStart',
    'ISpeechPhraseAlternate', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPELexicalForm', 'SPSHT_OTHER', 'SPPS_RESERVED2',
    'DISPID_SDKEnumKeys', 'SPPARTOFSPEECH', 'SPEI_INTERFERENCE',
    ...
    'DISPID_SPRuleConfidence', 'SP_VISEME_18', 'SAFTNoAssignedFormat',
    ...
    'SVEStartInputStream', 'SPCT_SUB_DICTATION',
    'DISPID_SpeechDataKey', 'eLEXTYPE_PRIVATE15',
    'DISPID_SPAs_NewEnum', 'SAFT48kHz8BitStereo', 'SVP_0',
    'DISPID_SpeechMemoryStream', 'SGDSActiveUserDelimited', 'SpVoice',
    'DISPID_SRRTOffsetFromStart', 'SPFM_OPEN_READONLY',
    'SREHypothesis', 'SpeechVoiceEvents',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SGRSTPropertyId',
    'eLEXTYPE_RESERVED10', 'DISPID_SRCEFalseRecognition',
    'SPEI_RECO_STATE_CHANGE', 'STCLocalServer',
    'SPEI_END_INPUT_STREAM', 'ISpeechLexiconWord', 'SPSNotOverriden',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRGCmdSetRuleIdState',
    'SPAR_Low', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SLGenerationId', 'SAFTExtendedAudioFormat',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SWFEBitsPerSample',
    ...
    'DISPID_SLGetWords', 'DISPID_SRRAudio', 'SpResourceManager',
    'DISPID_SRCCreateResultFromMemory', 'SpeechGrammarTagWildcard',
    'DISPID_SpeechRecoResult', 'SRADynamic', 'SAFTADPCM_8kHzStereo',
    'DISPID_SVPriority', 'DISPID_SRCVoice', 'SWTAdded',
    'SPTEXTSELECTIONINFO', 'DISPID_SVEVoiceChange', 'SREAllEvents',
    'DISPID_SRGetPropertyString', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SASFreeBufferSpace',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SDKSetStringValue',
    'ISpeechPhraseElement', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SVGetVoices', 'SpFileStream', 'SDTAll', 'SP_VISEME_12',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SOTs_NewEnum',
    'ISpPhoneticAlphabetSelection', 'DISPID_SpeechRecoResultTimes',
    'SPDKL_LocalMachine', 'SPPS_Interjection', 'DISPID_SPPs_NewEnum',
    'SAFT16kHz16BitMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SP_VISEME_0',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPIAudioSizeTime',
    'SAFT48kHz16BitStereo', 'DISPID_SPRuleId', 'DISPID_SRGRules',
    'SVP_12', 'DISPID_SRGetRecognizers', 'SDTReplacement',
    'DISPID_SGRClear', 'SPBO_PAUSE', 'SGSEnabled',
    'SWPUnknownWordUnpronounceable', 'eLEXTYPE_PRIVATE3', 'UINT_PTR',
    'SpeechRegistryUserRoot', 'SINoSignal',
    'DISPID_SPERetainedStreamOffset', 'SPEI_VISEME',
    'ISpResourceManager', 'SREPrivate',
    'DISPID_SpeechPhraseReplacement', 'SAFT48kHz16BitMono',
    'SPINTERFERENCE_NOSIGNAL', 'SpInProcRecoContext',
    'DISPID_SVResume', 'STCInprocServer', 'DISPID_SpeechRecoResult2',
    'SGRSTTWildcard', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SGRAddState', 'STSF_FlagCreate',
    'SpeechWordPronounceable', 'DISPID_SVEBookmark', 'SDTLexicalForm',
    'DISPID_SPIRule', 'SPSHT_EMAIL', 'eLEXTYPE_LETTERTOSOUND',
    'SPEI_RESERVED3', 'SPGS_DISABLED', 'SPEI_MAX_TTS',
    'DISPID_SPIEnginePrivateData', 'SPINTERFERENCE_NONE',
    'SREPropertyStringChange', 'DISPID_SGRAddResource',
    'DISPID_SRCERecognition', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SLWs_NewEnum', 'DISPID_SVSCurrentStreamNumber',
    'SpeechDiscardType', 'SGDSActive', 'SPSFunction',
    'DISPID_SpeechLexicon', 'DISPID_SVEPhoneme', 'SPSHORTCUTPAIRLIST',
    'SP_VISEME_17', 'DISPID_SMSSetData', 'SGDisplay', 'SLOStatic',
    'SRERecognition', 'SVSFUnusedFlags', 'ISpeechRecognizer',
    'eLEXTYPE_PRIVATE10', 'SPVOICESTATUS', 'SPAS_CLOSED',
    'SAFT12kHz8BitStereo', 'SVP_1', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SPEActualConfidence', 'SPBOOKMARKOPTIONS',
    'SPSEMANTICFORMAT', 'SpeechCategoryRecoProfiles',
    ...
    'DISPID_SpeechVoiceEvent', 'SAFT32kHz16BitMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SpeechRecognitionType',
    'DISPID_SGRSRule', 'SPEI_FALSE_RECOGNITION', 'SINoise',
    'SpeechTokenShellFolder', 'DISPID_SpeechRecognizer',
    'DISPID_SRCEventInterests', 'SDTRule', 'SPXRO_Alternates_SML',
    'eLEXTYPE_PRIVATE11', 'SBONone', 'SPLOADOPTIONS', 'SRTStandard',
    'SAFT12kHz16BitStereo', 'DISPID_SASState', 'SVP_13',
    'SAFT32kHz8BitMono', 'SPEI_TTS_AUDIO_LEVEL',
    'SAFTGSM610_22kHzMono', 'SP_VISEME_3', 'SVEBookmark',
    'DISPID_SPPName', 'SpeechEngineProperties',
    'DISPID_SRRGetXMLResult', '__MIDL_IWinTypes_0009',
    'DISPID_SLGetGenerationChange', 'ISpRecoGrammar',
    ...
    'DISPID_SOTMatchesAttributes', 'SVEVoiceChange', 'DISPIDSPTSI',
    'SPFM_NUM_MODES', 'SDA_One_Trailing_Space',
    'DISPID_SVSpeakCompleteEvent', 'SpeechLoadOption',
    'DISPID_SGRSTRule', 'SPSHT_Unknown', 'SVP_7',
    'SpeechRuleAttributes', 'SAFT22kHz8BitMono', 'SpeechInterference',
    'SAFT44kHz16BitStereo', 'eLEXTYPE_PRIVATE8', 'STCInprocHandler',
    'SP_VISEME_14', 'SpeechMicTraining', 'DISPID_SPEAudioSizeTime',
    'SPXMLRESULTOPTIONS', 'DISPID_SOTGetDescription',
    'ISpeechRecoContext', 'SSSPTRelativeToEnd',
    'SDA_Two_Trailing_Spaces', 'DISPID_SGRSTPropertyValue',
    'DISPID_SPIProperties', 'eLEXTYPE_RESERVED9', 'DISPID_SGRsAdd',
    'SECFEmulateResult', 'eLEXTYPE_RESERVED8',
    'SpUnCompressedLexicon', 'SpeechCategoryAppLexicons',
    'SP_VISEME_13', 'SAFT11kHz8BitMono', 'SpeechGrammarWordType',
    'SPAS_STOP', 'SPCT_DICTATION', 'SpeechAddRemoveWord',
    'ISpRecoContext', 'ISpeechLexiconWords', 'SECFIgnoreCase',
    'DISPID_SPRs_NewEnum', 'SPADAPTATIONRELEVANCE',
    'Speech_Max_Pron_Length', 'ISpMMSysAudio', 'DISPID_SPIGrammarId',
    'SRTExtendableParse', 'SAFTNonStandardFormat', 'SPLO_DYNAMIC',
    'SDTProperty', 'SITooQuiet', 'SP_VISEME_2', 'DISPID_SPRulesItem',
    'DISPID_SGRSAddRuleTransition', 'SVSFParseSsml',
    'SpeechTokenKeyFiles', 'SpeechVisemeFeature',
    'DISPID_SpeechLexiconWords', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRCEStartStream', 'DISPID_SPIReplacements',
    'DISPID_SRRTStreamTime', 'SPCONTEXTSTATE', 'SPSNoun',
    'DISPID_SVEWord', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SGRSTransitions', 'SpeechTokenIdUserLexicon',
    'SVSFPersistXML', 'DISPID_SPRuleChildren', 'DISPID_SRRTLength',
    'ISpeechLexiconPronunciations', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SDTPronunciation', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SMSAMMHandle', 'DISPID_SRStatus',
    'DISPID_SRCSetAdaptationData',
    'DISPID_SRCERecognitionForOtherContext', 'SpMMAudioIn',
    'SPBO_TIME_UNITS', 'SAFTCCITT_uLaw_44kHzStereo', 'SpObjectToken',
    'DISPID_SDKCreateKey', 'SpeechRecoProfileProperties',
    'SPEI_MAX_SR', 'DISPID_SRCRecognizer', 'ISpEventSource',
    'SpeechTokenKeyAttributes', 'SWPUnknownWordPronounceable',
    'DISPID_SRCERequestUI', 'ISpPhoneticAlphabetConverter',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SVAudioOutputStream',
    'DISPID_SGRsItem', 'ISpStreamFormat', 'eLEXTYPE_RESERVED4',
    'SPAR_Medium', 'DISPID_SRSetPropertyNumber', 'SPRECOSTATE',
    'DISPID_SRCEAdaptation', 'ISpPhraseAlt',
    'ISpeechPhraseReplacement', 'SPEI_PHONEME', 'SRSEDone',
    'Speech_Default_Weight', 'SpeechRetainedAudioOptions',
    'DISPID_SGRSAddWordTransition', 'SAFTGSM610_8kHzMono',
    'DISPID_SPEsItem', 'IInternetSecurityManager',
    'DISPID_SMSADeviceId', 'SRAExport', 'SpeechAudioFormatGUIDWave',
    'DISPID_SADefaultFormat', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRCEPhraseStart', 'SPWAVEFORMATTYPE',
    'DISPID_SWFEBlockAlign', 'DISPID_SpeechWaveFormatEx',
    'SpSharedRecoContext', 'ISpProperties', 'DISPID_SDKDeleteKey',
    ...
    'SAFTCCITT_uLaw_44kHzMono', 'IStream', 'SpeechRecognizerState',
    'SVEAllEvents', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRRTimes', 'DISPID_SpeechAudio', 'SRSInactive',
    'SPRS_ACTIVE_USER_DELIMITED', 'SAFT22kHz16BitMono',
    'DISPID_SWFEAvgBytesPerSec', 'Speech_Max_Word_Length',
    'SPPS_Modifier', 'DISPID_SGRsCount', 'SPRECORESULTTIMES',
    'eLEXTYPE_PRIVATE6', 'SpCustomStream', 'ISpeechMMSysAudio',
    'ISpeechObjectToken', 'SPDKL_DefaultLocation',
    'SAFT44kHz8BitMono', 'ISpRecoCategory', 'SPSModifier',
    'ISpRecognizer2', 'DISPID_SVGetAudioOutputs', 'SPAS_PAUSE',
    'SpNullPhoneConverter', 'SSFMOpenForRead',
    'DISPID_SDKGetlongValue', 'SPAO_NONE', 'SPEI_RESERVED1',
    '_SPAUDIOSTATE', 'SP_VISEME_10', 'SPCT_SLEEP',
    'DISPID_SRSAudioStatus', 'DISPID_SPEDisplayText', 'SVP_20',
    'SRATopLevel', 'DISPID_SOTRemove', 'SPEI_HYPOTHESIS',
    'ISpeechWaveFormatEx', 'SAFT12kHz16BitMono', 'eLEXTYPE_PRIVATE7',
    'SpStream', 'ISpeechResourceLoader', 'DISPID_SRCEEnginePrivate',
    'SVPAlert', 'SSFMCreateForWrite', 'SpeechAudioFormatGUIDText',
    ...
    'DISPID_SRRTTickCount', 'ISpeechGrammarRules',
    'SPPS_NotOverriden', 'SASPause', 'SSTTWildcard',
    ...
    'SPSMF_SAPI_PROPERTIES', 'SPEI_END_SR_STREAM', 'SPWT_LEXICAL',
    'eLEXTYPE_PRIVATE17', 'ISpNotifySource',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpeechPhraseElements',
    'DISPID_SOTsItem', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SPRules_NewEnum', 'DISPID_SRAudioInputStream',
    'ISpeechRecoResultDispatch', 'eLEXTYPE_PRIVATE18',
    'SAFT48kHz8BitMono', 'ISpeechCustomStream', 'SDTAlternates',
    'DISPID_SpeechPhraseInfo', 'SAFT12kHz8BitMono',
    'DISPID_SRGetPropertyNumber', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SVAudioOutput', 'SpTextSelectionInformation',
    'DISPID_SVPause', 'SpLexicon', '_RemotableHandle'
]

_check_version('1.2.0', 1651900789.649301)
